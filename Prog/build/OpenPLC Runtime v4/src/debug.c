...
char plc_program_md5[] = "85f51172bcab09bf1969d88e2bb2a8e9";
...
static const struct {
    ...
    {&(RES0__INSTANCE0.TESTFUNKTION.EN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TESTFUNKTION.ENO), BOOL_ENUM},
    {&(RES0__INSTANCE0.TESTFUNKTION.INPUT), BOOL_ENUM},
    {&(RES0__INSTANCE0.TESTFUNKTION.OUTPUT), BOOL_ENUM},
